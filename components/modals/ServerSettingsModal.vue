...
<template>
  <DialogRoot v-model:open="open">
    ...
    <DialogPortal>
      ...
      >
        <div
          class="relative mx-auto w-screen max-w-md space-y-4 rounded-md bg-gray-700 px-6 py-4 text-gray-300"
        >
              ...
              <div class="space-y-2">
                ...
                <div class="flex justify-between">
                  <BaseButton
                    ...
                    class="rounded px-4 py-2 text-gray-100 transition"
                    :class="[
                      invalidateSuccess
                        ? 'bg-green-500'
                  ...
                  <button
                    type="button"
                    class="rounded bg-gray-600 px-4 py-2 text-gray-100 transition hover:bg-gray-500"
                  >
                    Bans
                  </button>
                </div>
